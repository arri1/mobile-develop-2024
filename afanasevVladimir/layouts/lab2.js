...
const Lab2 = () => {
  ...
  return (
    <View style={[styles.container, { backgroundColor: isDarkTheme ? "#333" : "#F5FCFF" }]}>
      ...
      <TextInput
        style={[styles.input, { borderColor: isDarkTheme ? "#FFF" : "#ccc", color: isDarkTheme ? "#FFF" : "#000" }]}
      ...
      <FlatList
        ...
        renderItem={({ item }) => (
          <View style={styles.weatherItem}>
            ...
            <Text style={[styles.condition, { color: isDarkTheme ? "#FFF" : "gray" }]}>{item.condition}</Text>
          </View>
        )}
      />
    </View>
